# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-11-20 21:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archs', models.ManyToManyField(blank=True, null=True, to='repo.Arch')),
                ('components', models.ManyToManyField(blank=True, null=True, related_name='containers', to='repo.Repo')),
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repo.Platform')),
                ('projects', models.ManyToManyField(blank=True, null=True, to='repo.Project')),
            ],
        ),
        migrations.CreateModel(
            name='RepoServer',
        ...
        migrations.AddField(
            model_name='pointer',
            name='target',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repo.Repo', unique=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='platform',
            field=models.ManyToManyField(blank=True, null=True, to='repo.Platform'),
        ),
        migrations.AddField(
            model_name='image',
            name='container_repo',
        ...
        migrations.AddField(
            model_name='image',
            name='repo',
            field=models.ManyToManyField(blank=True, null=True, to='repo.Repo'),
        ),
        migrations.AddField(
            model_name='graph',
            name='image',
